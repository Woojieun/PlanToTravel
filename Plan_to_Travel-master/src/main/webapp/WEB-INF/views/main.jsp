            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <form id="mypage_form" method="post">
                    <div class="offcanvas-header">
                        <c:if test="${ user != null }">
                            <h5 class="offcanvas-title" id="offcanvasNavbarLabel">${user.uID}님</h5>
                        </c:if>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        <div class="offcanvas-divider"></div> <!-- 구분선 추가 -->
                    </div>
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" type="button" aria-current="page" id="History">스케줄
                                    History</a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas_Journal" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
            ...
            <button type="button" class="btn btn-outline-primary" title="여행 일지 추가하기"><i
                    class="bi bi-plus-lg"></i></button> <!-- 여행 일지 추가 -->
        </div>
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="modal_close_btn" class="btn btn-secondary"
        ...
        <div class="memo_write">
            <div class="card" style="width: 65.5rem;">
                <div class="card-body" style="height: 50px;">
                    ...
                    <input type="text" id="memo_text_id" placeholder="title" style="display: none;"> <!-- 장소 아이디 -->
                </div>
