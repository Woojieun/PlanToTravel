...
<script
	src="https://apis.openapi.sk.com/tmap/jsv2?version=1&appKey=5A53DsGwddaFFyXqIjgmU8VGi3Vsx3Yb8DYy3kT7">
  </script>
...
<!-- 						<li class="nav-item"><a class="nav-link active" type="button"
	...
	<div class="modal fade" id="deleteSuccessModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">스케줄을 성공적으로 삭제하였습니다.</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary"
						data-bs-dismiss="modal">확인</button>
				</div>
	...
	<!-- 여행 일지 -->
	<div class="offcanvas offcanvas-end" tabindex="-1"
		id="Offcanvas_Journal" aria-labelledby="offcanvasNavbarLabel">
		<div class="offcanvas-header">
			<button type="button" class="btn btn-outline-primary"
				data-bs-dismiss="offcanvas" type="button">
				<i class="bi bi-arrow-left"></i>
		...
		<div class="offcanvas-body">
			<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
				<li class="nav-item">
					<button class="nav-link active" type="button" aria-current="page"
						id="Journal">부산 여행 일지</button> <input class="form-check-input"
					type="checkbox" value="" id="Journal_Check">
				</li>
				<li class="nav-item">
					<button class="nav-link active" type="button" aria-current="page"
						id="Journal">일본 후쿠오카 일지</button> <input class="form-check-input"
					type="checkbox" value="" id="Journal_Check">
				</li>
				<li class="nav-item">
					<button class="nav-link active" type="button" aria-current="page"
						id="Journal">제주도 여행 일지</button> <input class="form-check-input"
					type="checkbox" value="" id="Journal_Check">
				</li>
			</ul>
		</div>
	...
	<div class="container-fluid-table">
			...
			<div class="col-md">
				<div class="form-floating">
					<input type="text" class="form-control" id="datepicker_start"
						placeholder="시작 날짜"> <label for="floatingInput">시작
						날짜</label>
				</div>
			</div>
			<div class="col-md">
				<div class="form-floating">
					<input type="text" class="form-control" id="datepicker_end"
						placeholder="종료 날짜"> <label for="floatingInput">종료
						날짜</label>
				</div>
			</div>
			<div class="col-md">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" id="modal_close_btn" class="btn-close"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" id="box_title_modal_close" class="btn-close"
							data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
		...
		<div id="title_container">
			<form method="post" target='blankifr'>
				...
				<input class="form-control" id="location_uuid" name="location_uuid"
					type="hidden">
				<!-- type="hidden" -->
				<input type="text" class="form-control" id="travel_title"
					placeholder="일정표 제목 입력"> <input type="submit"
					id="travel_save" class="btn btn-outline-primary" value="저장">
			</form>
		</div>
		<br />

		<div id="travel_table_container">
			<div class="row date_container" id="dateRangeOutput"
	...
	<div id="map_div_container">
		<div class="_map_layer_btn_group">
			<div class="_map_layer_btn">
				<button type="button" onclick="map_div_home_show();"
					class="btn btn-outline-primary btn-sm">지도 홈</button>
				<button type="button" onclick="map_div_pedestrian_show();"
					class="btn btn-outline-secondary btn-sm">도보</button>
				<button type="button" onclick="map_car_show();"
					class="btn btn-outline-success btn-sm">자동차</button>
				<button type="button" class="btn btn-outline-dark btn-sm"
					id="resetButton">지도 초기화</button>
			</div>
			...
			<jsp:include page="/WEB-INF/views/map_car.jsp" />
				...
				<button type="button" class="place_add btn btn-outline-info btn-sm"
					id="place_add">장소 추가</button>
				<button type="button"
					class="place_add_ped btn btn-outline-info btn-sm"
					id="place_add_ped">장소 추가</button>
				<button type="button"
					class="place_add_car btn btn-outline-info btn-sm"
					id="place_add_car">장소 추가</button>
			</div>
		</div>
	</div>
