...
<body>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item"><a class="nav-link active" type="button" aria-current="page"
                                id="History">스케줄 History</a></li>
                        <li class="nav-item"><a class="nav-link active" type="button" aria-current="page"
                                id="Journal">여행 일지</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas_Favorites" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
            <button type="button" class="btn btn-outline-primary" data-bs-dismiss="offcanvas" type="button">
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    ...
                    <button type="button" id="Favorites_cancel">
                        <i class="bi bi-x"></i>
                    </button> <!-- 즐겨찾기 삭제 -->
                </li>
                <li class="nav-item">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas_History" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
            ...
            <!-- 뒤로가기 -->
            <button type="button" class="btn btn-outline-primary" title="스케줄 추가하기" id="new_schedule">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas_Journal" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
            ...
            <!-- 뒤로가기 -->
            <button type="button" class="btn btn-outline-primary" title="여행 일지 추가하기">
                <i class="bi bi-plus-lg"></i>
            </button>
            <!-- 여행 일지 추가 -->
        </div>
    ...
    <div class="container-fluid-table">
        ...
        <div class="row g-2" id="form_floating_div">
            <div class="col-md">
                <div class="form-floating">
                    <input type="text" class="form-control" id="datepicker_start" placeholder="시작 날짜"> <label
                        for="floatingInput">시작
                        날짜</label>
                </div>
            </div>
            <div class="col-md">
                <div class="form-floating">
                    <input type="text" class="form-control" id="datepicker_end" placeholder="종료 날짜"> <label
                        for="floatingInput">종료
                        날짜</label>
                </div>
            </div>
            <div class="col-md">
        ...
        <div id="title_container">
            <form method="post" target='blankifr'>
                ...
                <input type="hidden" class="form-control" id="location_uuid" name="location_uuid"> <input type="text"
                    class="form-control" id="travel_title" placeholder="일정표 제목 입력">
        ...
        <div id="map_div_container">
            <div class="_map_layer_btn_group">
                <div class="_map_layer_btn">
                    <button type="button" onclick="map_div_home_show();" class="btn btn-outline-primary btn-sm">지도
                        홈</button>
                ...
                <button type="button" class="place_add btn btn-outline-info btn-sm">장소
                    추가</button>
            </div>
        </div>
            ...
            <div class="memo_write">
                <div class="card" style="width: 65.5rem;">
                    <div class="card-body" style="height: 50px;">
                        ...
                        <input type="text" id="memo_text" placeholder="title"> <input type="text" id="memo_text_id"
                    ...
                    <div class="card-body" style="height: 50px; width: 700px;">
                        ...
                        <input type="text" id="memo_place" placeholder="place"> <input type="text" class="form-control"
                            id="memo_place_lat" style="display: none;"> <input type="text" class="form-control"
                            id="memo_place_lng" style="display: none;">
                    </div>
