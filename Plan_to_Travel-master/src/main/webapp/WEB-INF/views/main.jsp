		...
		<div class="container-fluid">
			...
			<div class="offcanvas offcanvas-end" tabindex="-1"
				...
				<ul class="navbar-nav mt-auto">
					<li class="nav-item ms-3"><a class="nav-link active" type="button"
						id="logout" href="/logout">로그아웃</a></li>
				</ul>
			</div>
		</div>
	</nav>
...
<div class="modal fade" id="deleteAllModal" tabindex="-1" role="dialog" aria-labelledby="deleteAllModalLabel" aria-hidden="true">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas_History" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
            <button type="button" class="btn btn-outline-primary" data-bs-dismiss="offcanvas" type="button"><i
                    class="bi bi-arrow-left"></i></button> <!-- 뒤로가기 -->
            <button type="button" class="btn btn-outline-primary" id="new_schedule" title="스케줄 추가하기"><i
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas_Journal" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
            <button type="button" class="btn btn-outline-primary" data-bs-dismiss="offcanvas" type="button"><i
                    class="bi bi-arrow-left"></i></button> <!-- 뒤로가기 -->
            <button type="button" class="btn btn-outline-primary" title="여행 일지 추가하기"><i
                    class="bi bi-plus-lg"></i></button>
            <!-- 여행 일지 추가 -->
        </div>
        <div class="offcanvas-body">
    ...
    <div id="map_div_container">
        <div class="_map_layer_btn_group">
            ...
            <div class="button-container">
                <button type="button" class="favorite_add btn btn-outline-info btn-sm" id="favorite_add">즐겨찾기</button>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="placeInfo" style="resize: none;" rows="4"
                                required></textarea>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="closeModal" class="btn btn-primary" data-dismiss="modal">확인</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="memo_write">
            <div class="card" style="width: 65.5rem;">
                ...
                <div class="card-body" style="height: 230px;">
                    <textarea id="memo_content" name="content" rows="8" cols="132" placeholder="memo"
                        style="resize: none;"></textarea>
                </div>

                <div class="card-body" style="height: 230px;">
                    <textarea id="review_content" name="content" rows="8" cols="132" placeholder="review"
                        style="resize: none;"></textarea>
                </div>
