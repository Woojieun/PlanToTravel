...
<head>
    ...
    <script
        src="https://apis.openapi.sk.com/tmap/jsv2?version=1&appKey=5A53DsGwddaFFyXqIjgmU8VGi3Vsx3Yb8DYy3kT7 autoload=true">
    </script>
</head>
...
<body>
    <div id="map_div_home">
        <div class="_map_layer_overlay_home">
            ...
            <div class="_map_overlay_row_home">
                <input type="text" class="_search_entry" id="searchAddress_home" placeholder="목적지를 입력하세요"
                    onkeyup="onKeyupSearchLocation_home(this);">
                <button class="btn btn-primary btn-sm" onclick="apiSearchLocation_home();"
            ...
            var params_home = {
              ...
              `;
                    ...
                    for (var k_home in resultpoisData_home) {
                        ...
                        var fullAddressRoad_home = resultpoisData_home[k_home].newAddressList.newAddress[0]
                            .fullAddressRoad;
                      ...
                      \${(resultpoisData_home.length-1) == Number(k_home) ? "": ` < div class = "_search_item_split" >
                            <
                            /div>`}
                        `;
  ...
  function poiDetail_home(poiId_home, thisK_home) {
      for(let tMarker_home of markerPoi_home) {
          ...
          tMarker_home.setIconHTML(` <
                        ...
                        style = "position:relative;" >
                            <
                            img src = "/lib/img/_icon/marker_grey.svg"
                        style = "width:48px;height:48px;position:absolute;" / >
                            <
                            div style =
                            "position:absolute; width:48px;height:42px; display:flex; align-items:center; justify-content: center; color:#FAFBFF; font-family: 'SUIT';font-style: normal;font-weight: 700;font-size: 15px;line-height: 19px;" >
                            \$ {
                                Number(forK_home) + 1
                            } < /div> < /
                            div >
      ...
      markerPoi_home[thisK_home].setIconHTML(` <
                        ...
                        style = "position:relative;" >
                            <
                            img src = "http://tmapapi.sktelecom.com/upload/tmap/marker/pin_b_m_p.png"
                        style = "width:48px;height:48px;position:absolute;" / >
                            <
                            div style =
                            "position:absolute; width:48px;height:42px; display:flex; align-items:center; justify-content: center; color:#FAFBFF; font-family: 'SUIT';font-style: normal;font-weight: 700;font-size: 15px;line-height: 19px;" >
          ...
          onComplete: function(result) {
              ...
              var content_home = ` <
                        div class = "_tmap_preview_popup_text" >
                            ...
                            <
                            div class = "_tmap_preview_popup_title" > \$ {
                                name_home
                            } < /div> <
                        div class = "_tmap_preview_popup_address"
                        style = "width:150px;" > \$ {
                            bldAddr_home
                        } < /div> <
                        div class = "_tmap_preview_popup_address" > \$ {
...
*/                            
              if(tel_home !== "") {
            	  content_home += ` < div class = "_tmap_preview_popup_address" > \$ {
                            tel_home
                        } < /div>`;
                    }
        ...
        $(document).ready(function () {
            ...
            function addMarker(map, markerLayer, latitude, longitude) {
                if (marker1_home) {
                    ...
                    var lonlat = new Tmapv2.LatLng(latitude, longitude);
                    marker1_home.setPosition(
                        lonlat); // Use the setPosition method to update the marker's position
                    ...
                    var icon = new Tmapv2.MarkerImage(
                        "http://tmapapi.sktelecom.com/upload/tmap/marker/pin_b_m_p.png", new Tmapv2.Size(24,
                            38), new Tmapv2.Point(-(24 / 2), -38));

                    var marker = new Tmapv2.Marker(lonlat, {
                        icon: icon
                    });
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (map_div_home && markerLayer) {
                                    ...
                                    addMarker(map_div_home, markerLayer,
                                        response.latitude, response
                                        .longitude);
                                } else {
                                    console.error(
                                        'Map or markerLayer is not initialized'
                                    );
                                }
                                ...
                                var {
                                    map,
                                    markerLayer
                                } = initMap(response.latitude, response
                                    .longitude);
                                addMarker(map, markerLayer, response.latitude,
                                    response.longitude);
                            },
