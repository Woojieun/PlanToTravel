        ...
        success: function (data) {
            ...
            for (var date in scheduleGroups) {
                ...
                for (var j = 0; j < scheduleGroups[date].length; j++) {
                    ...
                    scheduleHtml += '<div class="card text-white bg-info card_package" id="box_title_' + (j + 1) + '_' + (j + 1) + '">';
    ...
    if (box_title_index < 13) {
        ...
        innerHtml += `<div class="card text-white bg-info card_package" id="box_title_1_` + box_title_index + `">
            <div class="card-title uuid" id=${generatedUuid}>
                <div class="title" id="title1_` + box_title_index + `" tabindex="-1">title</div>
                <div class="deleteBox">x</div>
            </div>
        </div>`;
...
<div class="card-title uuid" id=${generatedUuid}>
<div class="title" id="title2_` + box_title_index2 + `" tabindex="-1">title</div>
<div class="deleteBox">x</div>
</div>
</div>
`
...
<div class="card-title uuid" id=${generatedUuid}>
<div class="title" id="title3_` + box_title_index3 + `" tabindex="-1">title</div>
<div class="deleteBox">x</div>
</div>
</div>
`
...
<div class="card-title uuid" id=${generatedUuid}>
<div class="title" id="title4_` + box_title_index4 + `" tabindex="-1">title</div>
<div class="deleteBox">x</div>
</div>
</div>
`
...
<div class="card-title uuid" id=${generatedUuid}>
<div class="title" id="title5_` + box_title_index5 + `" tabindex="-1">title</div>
<div class="deleteBox">x</div>
</div>
</div>
`
...
<div class="card-title uuid" id=${generatedUuid}>
<div class="title" id="title6_` + box_title_index6 + `" tabindex="-1">title</div>
<div class="deleteBox">x</div>
</div>
</div>
`
