var map = new Tmapv3.Map("map_div", { // 지도가 생성될 div
        center: new Tmapv3.LatLng(37.56063619099832, 127.01233863830606),    // 지도의 중심좌표
        width : "750px", // 지도의 넓이
        height : "750px", // 지도의 높이
        zoom : 12, // 지도의 줌레벨
...
/* 
                var labelInfo2 = new Tmapv3.Label({
            ...
            var params = {
                onComplete: function (result) {
                    ...
                    if (drawMode == "apiRoutesPedestrian") {
                        ...
                        reset();
                        // 시작마커설정
                        markerStart_car = new Tmapv3.Marker({
                            position: new Tmapv3.LatLng(starty, startx),
                            // icon: "http://topopen.tmap.co.kr/imgs/start.png",
                            iconHTML: '
                            <div class='_t_marker' style="position:relative;" >
                                <img src="http://topopen.tmap.co.kr/imgs/start.png" style="width:48px;height:48px;position:absolute;"/>
                                <div style="position:absolute; width:48px;height:42px; display:flex; align-items:center; justify-content: center; color:#FAFBFF; font-family: 'SUIT';font-style: normal;font-weight: 700;font-size: 15px;line-height: 19px;">
                                출발</div>
                            </div>
                            ',
                        ...
                        markerEnd = new Tmapv3.Marker({
                            ...
                            iconHTML: '
                            <div class='_t_marker' style="position:relative;" >
                                <img src="http://topopen.tmap.co.kr/imgs/arrival.png" style="width:48px;height:48px;position:absolute;"/>
                                <div style="position:absolute; width:48px;height:42px; display:flex; align-items:center; justify-content: center; color:#FAFBFF; font-family: 'SUIT';font-style: normal;font-weight: 700;font-size: 15px;line-height: 19px;">
                                도착</div>
                            </div>
                            ',
                            ...
                            if (geometry.type == "LineString") {
                                ...
                                if (properties.pointType == "S") { //출발지 마커
                                    markerStart_car = new Tmapv3.Marker({
                                        ...
                                        iconHTML: '
                                        <div class='_t_marker' style="position:relative;" >
                                            <img src="resources/img/start.png" style="width:48px;height:48px;position:absolute;"/>
                                            <div style="position:absolute; width:48px;height:42px; display:flex; align-items:center; justify-content: center; color:#FAFBFF; font-family: 'SUIT';font-style: normal;font-weight: 700;font-size: 15px;line-height: 19px;">
                                            출발</div>
                                        </div>
                                        ',
