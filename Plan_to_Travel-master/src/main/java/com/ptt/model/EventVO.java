...
public class EventVO {
	...
	public String toString() {
		return "EventVO [event_id=" + event_id + ", sche_id=" + sche_id + ", event_num=" + event_num + ", event_title="
				+ event_title + ", event_datetime=" + event_datetime + ", event_place=" + event_place + ", event_lat="
				+ event_lat + ", event_lng=" + event_lng + ", event_memo=" + event_memo + ", event_review="
				+ event_review + "]";
	}
